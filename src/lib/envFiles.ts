...
export async function readEnvFile(file: EnvFileName): Promise<{ map: Record<string, string>; lines: string[]; eol: string }>{
...
export async function writeEnvFile(file: EnvFileName, updates: Record<string, string | boolean>) {
