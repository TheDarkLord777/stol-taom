...
export function CardHoverEffect({
  ...
  const Div: any = interactive ? motion.div : "div";
  const IconWrapper: any = interactive ? motion.span : "span";
              ...
              {GRID_STRUCTURE.rows.map((row, i) => (
                <div
                  ...
                  className={cn(
                    ...
                    `bg-linear-to-r from-${(VARIANTS as any)[variant].accent}/0 via-${(VARIANTS as any)[variant].accent}/20 to-${(VARIANTS as any)[variant].accent}/0`,
                  )}
                  style={{
                    top: `${row.start}%`,
              ...
              {GRID_STRUCTURE.columns.map((col, i) => (
                <div
                  ...
                  className={cn(
                    ...
                    `bg-linear-to-b from-${(VARIANTS as any)[variant].accent}/0 via-${(VARIANTS as any)[variant].accent}/20 to-${(VARIANTS as any)[variant].accent}/0`,
                  )}
                  style={{
                ...
                {GRID_STRUCTURE.columns.map((col, colIndex) => (
                  <div
                    ...
                    className={cn(
                      ...
                      `bg-linear-to-br ${(VARIANTS as any)[variant].gradient}`,
                    )}
                    style={{
                      top: `${row.start}%`,
                      left: `${col.start}%`,
